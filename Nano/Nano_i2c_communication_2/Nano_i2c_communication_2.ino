...
void back() {
  if (correct == 7) {// Go back
    turnM1 (-10*speedMulitply);
    turnM2 (-10*speedMulitply);
  }else if (correct == 8) { // Correct Left, puts more power to motor 1
    turnM1 (-10*speedMulitply);
    turnM2 (-9*speedMulitply);
  }else if (correct == 9) {// Correct Right, puts more power to motor 2
    turnM1 (-9*speedMulitply);
    turnM2 (-10*speedMulitply);
  }
  turnM3 (0);
}
