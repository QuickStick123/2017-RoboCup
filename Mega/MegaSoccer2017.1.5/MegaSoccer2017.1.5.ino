...
void nanoCom() {
  ...
  Wire.write(Identifier + correctAmount + DirectionGo * motorsOn + kicker * canKick); //sum of numbers used to help filter out bad dat
  kicker = false;
...
void haveBallLogic() {
  ...
  void haveBallCalc() {
      ...
      Serial.print(laser2On);
      if(laser1On == false || laser2On == false){ //if sensor 14 or 15 is getting a reading. pulseTime[13] > 350 || 
