...
void nanoCom() {
  ...
  correctAmount = byte(100 - (abs(calibratedCompassValue) / 1));
  if (correctAmount < 85) {
...
void ultrasonicDistanceSide() {
  if (leftUltraSonic + rightUltraSonic < 185 && abs(calibratedCompassValue)) {
...
void ultrasonicDistanceFront() {
  ...
  */
  if (frontUltraSonic + backUltraSonic < 240) {
